...
} from 'src/components/admin/pages/CharacteristicValues/Create/AdminCharacteristicValuesCreatePresenter';
import { AdminCharacteristicValuesCreateView } from 'src/components/admin/pages/CharacteristicValues/Create/AdminCharacteristicValuesCreateView';
