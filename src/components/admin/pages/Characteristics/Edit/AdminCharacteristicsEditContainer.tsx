...
import { AdminCharacteristicsEditPresenter } from 'src/components/admin/pages/Characteristics/Edit/AdminCharacteristicsEditPresenter';
import { AdminCharacteristicsEditView } from 'src/components/admin/pages/Characteristics/Edit/AdminCharacteristicsEditView';
