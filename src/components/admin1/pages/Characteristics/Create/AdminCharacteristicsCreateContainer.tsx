...
import { AdminCharacteristicsCreatePresenter } from 'src/components/admin/pages/Characteristics/Create/AdminCharacteristicsCreatePresenter';
import { AdminCharacteristicsCreateView } from 'src/components/admin/pages/Characteristics/Create/AdminCharacteristicsCreateView';
